...
class ImagesController extends AbstractController
{
    ...
    #[Route('delete/{id}', name: 'app_images_delete')]
    public function delete(int $id,ManagerRegistry $doctrine): Response
    {
        $repoImages= $doctrine->getRepository(Images::class);
        ...
        return $this->redirectToRoute('app_event_show',  ['id' => $imagedel->getEvent()->getId()], Response::HTTP_SEE_OTHER);
    }
}
