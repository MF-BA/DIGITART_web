...
final class Version20230410210945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artwork (id_art INT AUTO_INCREMENT NOT NULL, id_room INT DEFAULT NULL, artwork_name VARCHAR(255) NOT NULL, id_artist INT DEFAULT NULL, artist_name VARCHAR(255) DEFAULT NULL, date_art DATE NOT NULL, description TEXT DEFAULT NULL, image_art VARCHAR(255) DEFAULT NULL, INDEX fk_art (id_room), PRIMARY KEY(id_art)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE bid (ID INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, offer INT NOT NULL, id_auction INT NOT NULL, id_user INT NOT NULL, PRIMARY KEY(ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
