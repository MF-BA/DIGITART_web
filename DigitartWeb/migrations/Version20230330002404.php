 ...
 */
final class Version20230330002404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE id_room id_room INT DEFAULT NULL, CHANGE event_name event_name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE id_room id_room INT NOT NULL, CHANGE event_name event_name VARCHAR(255) NOT NULL');
